            ...
            <div class="relative my-6 w-full">
                ...
                <div class="border-0 rounded-lg shadow-lg relative flex flex-col bg-white outline-none focus:outline-none mx-auto w-2/5">
                    ...
                    <div class="flex items-center">
                            <img class="w-16 mx-auto mt-3 mb-1" src="~/assets/images/coinsph.png"/>
                        </div>

                        <!--body-->

                        <div class="h-6"></div>
                        <div class="font-bold text-lg mb-2">Link Coins.ph</div>
                        <div class="relative p-6 pt-0 flex-auto text-left">
                            <p class="my-4 
                            font-medium text-slate-700 text-base leading-relaxed">
                                Enter your BCH Address:
                            </p>
                            <input class="w-full bg-gray-100 rounded-lg p-2 ml-0" v-model="message" placeholder="BCH Address...">
                        </div>

                        <!--footer-->
                        
                        <div class="flex items-center justify-end px-5 py-5">
                            <button class="text-white bg-blue-700 hover:bg-blue-800  font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 mt-1 w-full" type="button">
                            Connect
                            </button>
                        </div>
                    </div>
